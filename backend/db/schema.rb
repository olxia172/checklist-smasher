...
ActiveRecord::Schema.define(version: 2020_01_24_205814) do
  ...
  create_table "enjoyers", force: :cascade do |t|
    ...
    t.string "image"
    t.json "tokens"
    t.index ["confirmation_token"], name: "index_enjoyers_on_confirmation_token", unique: true
    t.index ["email"], name: "index_enjoyers_on_email", unique: true
    t.index ["reset_password_token"], name: "index_enjoyers_on_reset_password_token", unique: true
    t.index ["uid", "provider"], name: "index_enjoyers_on_uid_and_provider", unique: true
  end
