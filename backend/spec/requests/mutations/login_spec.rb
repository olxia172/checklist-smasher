...
RSpec.describe 'LoginMutation', type: :graphql do
  ...
  describe "when valid credentials" do
    context "when login via name" do
      let(:variables) { { input: { identifier: "Ola", password: "1234" } } }
    ...
    context "when login via email" do
      let(:variables) { { input: { identifier: "ola@test.pl", password: "1234" } } }
  ...
  describe "when invalid credentials" do
    context "when invalid password" do
      let(:variables) { { input: { identifier: "Ola", password: "123456789" } } }
    ...
    context "when user not present" do
      let(:variables) { { input: { identifier: "Ola44444", password: "1234" } } }
